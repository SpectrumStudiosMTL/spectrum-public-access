...
(function () {
  const W = 900, H = 620;
  const ASSET_PATH = "images/draw-templates/";
  ...
  const STRINGS = {
    en: {
      ...
      locked: "locked",
      colorLabel: "Color",
      autofill: "Auto-fill base color",
      clean: "Clean between the lines",
      drawLabel: "Draw",
      brush: "Brush",
      eraser: "Eraser",
      sizeLabel: "Size",
      ...
      tourSteps: [
        ...
        { sel: ".dyf-row-fillclean", title: "4. Fill & clean",
          text: "Auto-fill base color quickly fills the whole body in your chosen color. Clean between the lines trims off any strokes that spilled outside the template." },
    ...
    fr: {
      ...
      locked: "verrouill\u00e9",
      colorLabel: "Couleur",
      autofill: "Remplir la couleur de base",
      clean: "Nettoyer entre les lignes",
      drawLabel: "Dessiner",
      brush: "Pinceau",
      eraser: "Gomme",
      sizeLabel: "Taille",
      ...
      tourSteps: [
        ...
        { sel: ".dyf-row-fillclean", title: "4. Remplir et nettoyer",
          text: "Remplir la couleur de base remplit rapidement tout le corps avec la couleur choisie. Nettoyer entre les lignes retire les traits qui d\u00e9bordent du mod\u00e8le." },
